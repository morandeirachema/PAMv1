...
runs 0–227 and 229–272, and **every phase has shipped**, and the current
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.0.77** (the numbering moved to 0.0.x at v0.0.77). Releases
...
**[v0.0.77](https://github.com/morandeirachema/pamv1/releases/tag/v0.0.77)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.0.77`, is published and public.)
...
```bash
TAG=v0.0.77                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.0.77 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.0.77](https://github.com/morandeirachema/pamv1/releases/tag/v0.0.77)
was released on 2026-09-22**, and every manifest here pins its tag, `0.0.77` — image
digest
`sha256:36590ed1a224cd5486ed9d017ee86a39020ffaa0e3dc3809b9c2544626dd922a`, public
