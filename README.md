...
runs 0–227 and **every phase has shipped**, and the current
tagged, cosign-signed release is
**[v0.62.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.62.0)** (2026-08-27;
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.62.0**. Releases
...
**[v0.62.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.62.0)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.62.0`, is published and public.)
...
```bash
TAG=v0.62.0                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.62.0 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.62.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.62.0)
was released on 2026-08-27** and is what every manifest here pins — image digest
`sha256:8145ca1b345330deab466ad6ce370a977d424a70d69f6213f229f8ee061608b3`, public
