...
**[v0.11.1](https://github.com/morandeirachema/pamv1/releases/tag/v0.11.1)** (2026-08-07;
...
**[v0.11.1](https://github.com/morandeirachema/pamv1/releases/tag/v0.11.1)** keeps it
...
> `ghcr.io/morandeirachema/pamv1:0.11.1`, is published and public.)
...
```bash
TAG=v0.11.1                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.11.1 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.11.1](https://github.com/morandeirachema/pamv1/releases/tag/v0.11.1)
