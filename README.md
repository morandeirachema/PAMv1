...
runs 0–227 and 229–237, and **every phase has shipped**, and the current
tagged, cosign-signed release is
**[v0.65.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.65.0)** (2026-09-02;
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.65.0**. Releases
...
**[v0.65.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.65.0)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.65.0`, is published and public.)
...
```bash
TAG=v0.65.0                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.65.0 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.65.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.65.0)
was released on 2026-09-02** and is what every manifest here pins — image digest
`sha256:292045eba8ed55ad54fae14ff2460ee5d5b47d9731ca278cebb12411c078196c`, public
