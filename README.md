...
runs 0–141 and **every phase has shipped**, and the current
tagged, cosign-signed release is
**[v0.34.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.34.0)** (2026-08-15;
...
Phases 0–141, grouped by area. Every capability is exercised by tests and deploys as code.
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.34.0**. Releases
...
**[v0.34.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.34.0)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.34.0`, is published and public.)
...
```bash
TAG=v0.34.0                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.34.0 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.34.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.34.0)
was released on 2026-08-15** and is what every manifest here pins — image digest
`sha256:ee9efe2090e84ae8bed9c1d07769babaad6024bf0a0189a093dfd88f052f5303`, public
