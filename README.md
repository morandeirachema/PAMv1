...
runs 0–227 and 229–230, and **every phase has shipped**, and the current
tagged, cosign-signed release is
**[v0.62.1](https://github.com/morandeirachema/pamv1/releases/tag/v0.62.1)** (2026-08-31;
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.62.1**. Releases
...
**[v0.62.1](https://github.com/morandeirachema/pamv1/releases/tag/v0.62.1)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.62.1`, is published and public.)
...
```bash
TAG=v0.62.1                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.62.1 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.62.1](https://github.com/morandeirachema/pamv1/releases/tag/v0.62.1)
was released on 2026-08-31** and is what every manifest here pins — image digest
`sha256:38ad4e2b6e7014c5558c3cf678f82c3b33775ce881ccf677d626468cf9cd4783`, public
