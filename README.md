...
runs 0–121 and **every phase has shipped**, and the current
tagged, cosign-signed release is
**[v0.24.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.24.0)** (2026-08-14;
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.24.0**. Releases
...
**[v0.24.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.24.0)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.24.0`, is published and public.)
...
```bash
TAG=v0.24.0                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.24.0 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.24.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.24.0)
was released on 2026-08-14** and is what every manifest here pins — image digest
`sha256:81daffe77c05cbcb289475cdd240ee8682c7c68db5ecdc91125caf1f30c9a339`, public
