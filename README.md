...
**[v0.55.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.55.0)** (2026-08-25;
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.55.0**. Releases
...
**[v0.55.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.55.0)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.55.0`, is published and public.)
...
```bash
TAG=v0.55.0                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.55.0 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.55.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.55.0)
was released on 2026-08-25** and is what every manifest here pins — image digest
`sha256:dbf64c412451b025f4c94221c921d8991262c2d7e9026aac1b2b44fde74fb263`, public
