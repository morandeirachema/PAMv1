...
runs 0–156 and **every phase has shipped**, and the current
tagged, cosign-signed release is
**[v0.41.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.41.0)** (2026-08-16;
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.41.0**. Releases
...
**[v0.41.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.41.0)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.41.0`, is published and public.)
...
```bash
TAG=v0.41.0                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.41.0 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.41.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.41.0)
was released on 2026-08-16** and is what every manifest here pins — image digest
`sha256:0daa9ff20cca77a253c5f3b26c7bdb3abf1009039c8966589aa168fa5f408ce7`, public
