...
runs 0–227 and 229–249, and **every phase has shipped**, and the current
tagged, cosign-signed release is
**[v0.69.1](https://github.com/morandeirachema/pamv1/releases/tag/v0.69.1)** (2026-09-16;
...
Phases 0–227 and 229–249, grouped by area. Every capability is exercised by tests and deploys as code.
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.69.1**. Releases
...
**[v0.69.1](https://github.com/morandeirachema/pamv1/releases/tag/v0.69.1)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.69.1`, is published and public.)
...
```bash
TAG=v0.69.1                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.69.1 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.69.1](https://github.com/morandeirachema/pamv1/releases/tag/v0.69.1)
was released on 2026-09-16** and is what every manifest here pins — image digest
`sha256:c1f8d1b746db9bcedba408509ee7778d2e025dbebe1c516a8e63eb8044907ab1`, public
