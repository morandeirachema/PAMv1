...
runs 0–227 and 229–241, and **every phase has shipped**, and the current
tagged, cosign-signed release is
**[v0.66.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.66.0)** (2026-09-03;
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.66.0**. Releases
...
**[v0.66.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.66.0)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.66.0`, is published and public.)
...
```bash
TAG=v0.66.0                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.66.0 (<full commit sha>)
