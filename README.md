...
runs 0–209 and **every phase has shipped**, and the current
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.56.0**. Releases
...
**[v0.56.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.56.0)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.56.0`, is published and public.)
...
```bash
TAG=v0.56.0                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.56.0 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.56.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.56.0)
was released on 2026-08-26** and is what every manifest here pins — image digest
`sha256:6cc80bac424f22dd696cac7898b1b4837e95a3ac82be95da7000bfe1188df415`, public
