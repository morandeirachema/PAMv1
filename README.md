...
runs 0–134 and **every phase has shipped**, and the current
...
Phases 0–134, grouped by area. Every capability is exercised by tests and deploys as code.
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.30.0**. Releases
...
**[v0.30.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.30.0)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.30.0`, is published and public.)
...
```bash
TAG=v0.30.0                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.30.0 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.29.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.29.0)
was released on 2026-08-14** and is what every manifest here pins — image digest
`sha256:f203f30a9ff93b5885b3b15bb4e7bfd47771d1cb1f925cdfe72ab1177b2dea1a`, public
