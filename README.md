...
runs 0–202 and **every phase has shipped**, and the current
tagged, cosign-signed release is
**[v0.54.1](https://github.com/morandeirachema/pamv1/releases/tag/v0.54.1)** (2026-08-25;
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.54.1**. Releases
...
**[v0.54.1](https://github.com/morandeirachema/pamv1/releases/tag/v0.54.1)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.54.1`, is published and public.)
...
```bash
TAG=v0.54.1                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.54.1 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.54.1](https://github.com/morandeirachema/pamv1/releases/tag/v0.54.1)
was released on 2026-08-25** and is what every manifest here pins — image digest
`sha256:f2fcdc2d1b395056a62b5f1883f11cd10812758f243659affd75dddbb4b5936d`, public
