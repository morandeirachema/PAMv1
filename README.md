...
runs 0–216 and **every phase has shipped**, and the current
tagged, cosign-signed release is
**[v0.58.2](https://github.com/morandeirachema/pamv1/releases/tag/v0.58.2)** (2026-08-26;
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.58.2**. Releases
...
**[v0.58.2](https://github.com/morandeirachema/pamv1/releases/tag/v0.58.2)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.58.2`, is published and public.)
...
```bash
TAG=v0.58.2                       # the released version
...
#    it is `PAMv1` since v0.58.2 and was `pamv1` before — while the image name
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.58.2 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.58.2](https://github.com/morandeirachema/pamv1/releases/tag/v0.58.2)
was released on 2026-08-26** and is what every manifest here pins — image digest
`sha256:89cfc84e630e5ad93a814cc00da9d33090263b8b7ecab49ebe92e2c928d54e09`, public
