...
runs 0–135 and **every phase has shipped**, and the current
tagged, cosign-signed release is
**[v0.31.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.31.0)** (2026-08-15;
...
Phases 0–135, grouped by area. Every capability is exercised by tests and deploys as code.
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.31.0**. Releases
...
**[v0.31.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.31.0)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.31.0`, is published and public.)
...
```bash
TAG=v0.31.0                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.31.0 (<full commit sha>)
