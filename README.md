...
runs 0–220 and **every phase has shipped**, and the current
tagged, cosign-signed release is
**[v0.59.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.59.0)** (2026-08-27;
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.59.0**. Releases
...
**[v0.59.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.59.0)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.59.0`, is published and public.)
...
```bash
TAG=v0.59.0                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.59.0 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.59.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.59.0)
was released on 2026-08-27** and is what every manifest here pins — image digest
`sha256:cc5ae871f82666c3c8682d1e30889877f07054821819389d1a2d807fb2ddee89`, public
