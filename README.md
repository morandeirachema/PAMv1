...
runs 0–125 and **every phase has shipped**, and the current
tagged, cosign-signed release is
**[v0.26.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.26.0)** (2026-08-14;
...
Phases 0–125, grouped by area. Every capability is exercised by tests and deploys as code.
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.26.0**. Releases
...
**[v0.26.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.26.0)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.26.0`, is published and public.)
...
```bash
TAG=v0.26.0                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.26.0 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.25.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.25.0)
was released on 2026-08-14** and is what every manifest here pins — image digest
`sha256:0fc9f5dc847123599ae3cfd2a97b5fa8c9848fe0716af867b96d9861a89095d2`, public
