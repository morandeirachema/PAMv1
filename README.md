...
runs 0–227 and 229–267, and **every phase has shipped**, and the current
tagged, cosign-signed release is
**[v0.76.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.76.0)** (2026-09-17;
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.76.0**. Releases
...
**[v0.76.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.76.0)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.76.0`, is published and public.)
...
```bash
TAG=v0.76.0                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.76.0 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.76.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.76.0)
was released on 2026-09-17**, and every manifest here pins its tag, `0.76.0` — image
digest
`sha256:c0dd33432d1953d347fd6ce17638f6f04c69bc3455fdec384aa9d115dcd2bac5`, public
