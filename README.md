...
runs 0–227 and 229–245, and **every phase has shipped**, and the current
tagged, cosign-signed release is
**[v0.68.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.68.0)** (2026-09-15;
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.68.0**. Releases
...
**[v0.68.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.68.0)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.68.0`, is published and public.)
...
```bash
TAG=v0.68.0                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.68.0 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.68.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.68.0)
was released on 2026-09-15** and is what every manifest here pins — image digest
`sha256:6df1327b508ca558e4a47a65e9b34693f786a0a0428eb6bbeee0d9645645fb48`, public
