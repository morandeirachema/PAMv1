...
**[v0.14.1](https://github.com/morandeirachema/pamv1/releases/tag/v0.14.1)** (2026-08-08;
...
**[v0.14.1](https://github.com/morandeirachema/pamv1/releases/tag/v0.14.1)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.14.1`, is published and public.)
...
```bash
TAG=v0.14.1                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.14.1 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.14.1](https://github.com/morandeirachema/pamv1/releases/tag/v0.14.1)
was released on 2026-08-08** and is what every manifest here pins; its predecessor
v0.14.0 carried digest
`sha256:be024e68394c4500b1c49d57214109612d67667d27ad7ade216c8f10e94d5bcb`, and each
