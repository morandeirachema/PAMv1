...
**[v0.14.3](https://github.com/morandeirachema/pamv1/releases/tag/v0.14.3)**. The full list is in
...
```bash
TAG=v0.14.3                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.14.3 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.14.3](https://github.com/morandeirachema/pamv1/releases/tag/v0.14.3)
