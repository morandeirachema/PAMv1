...
runs 0–227 and 229–263, and **every phase has shipped**, and the current
tagged, cosign-signed release is
**[v0.75.1](https://github.com/morandeirachema/pamv1/releases/tag/v0.75.1)** (2026-09-17;
...
Phases 0–227 and 229–263, grouped by area. Every capability is exercised by tests and deploys as code.
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.75.1**. Releases
...
**[v0.75.1](https://github.com/morandeirachema/pamv1/releases/tag/v0.75.1)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.75.1`, is published and public.)
...
```bash
TAG=v0.75.1                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.75.1 (<full commit sha>)
