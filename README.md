...
broker four-eyes sound — released steadily as **v0.10.0 → v0.18.2**. Releases
...
**[v0.18.2](https://github.com/morandeirachema/pamv1/releases/tag/v0.18.2)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.18.2`, is published and public.)
...
```bash
TAG=v0.18.2                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.18.2 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.18.2](https://github.com/morandeirachema/pamv1/releases/tag/v0.18.2)
was released on 2026-08-12** and is what every manifest here pins — image digest
