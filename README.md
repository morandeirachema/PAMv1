...
runs 0–227 and 229–235, and **every phase has shipped**, and the current
tagged, cosign-signed release is
**[v0.64.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.64.0)** (2026-09-01;
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.64.0**. Releases
...
**[v0.64.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.64.0)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.64.0`, is published and public.)
...
```bash
TAG=v0.64.0                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.64.0 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.64.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.64.0)
was released on 2026-09-01** and is what every manifest here pins — image digest
`sha256:767016459749bb845e72a9af7b25f19b4bd4e02fdec5a769c267f26bb8ccd46d`, public
