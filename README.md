...
runs 0–218 and **every phase has shipped**, and the current
tagged, cosign-signed release is
**[v0.58.3](https://github.com/morandeirachema/pamv1/releases/tag/v0.58.3)** (2026-08-27;
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.58.3**. Releases
...
**[v0.58.3](https://github.com/morandeirachema/pamv1/releases/tag/v0.58.3)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.58.3`, is published and public.)
...
```bash
TAG=v0.58.3                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.58.3 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.58.3](https://github.com/morandeirachema/pamv1/releases/tag/v0.58.3)
was released on 2026-08-27** and is what every manifest here pins — image digest
`sha256:7367417aa1253fb1e47f108b967491ac8caed04a5556d6d62132e473cf9ec07f`, public
