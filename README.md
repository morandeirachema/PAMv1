...
runs 0–227 and 229–255, and **every phase has shipped**, and the current
tagged, cosign-signed release is
**[v0.72.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.72.0)** (2026-09-16;
...
Phases 0–227 and 229–255, grouped by area. Every capability is exercised by tests and deploys as code.
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.72.0**. Releases
...
**[v0.72.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.72.0)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.72.0`, is published and public.)
...
```bash
TAG=v0.72.0                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.72.0 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.72.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.72.0)
was released on 2026-09-16** and is what every manifest here pins — image digest
`sha256:82b295ea55de8f0f3825fda5a6be89aa865c32907240d945654c97f68858c8b9`, public
