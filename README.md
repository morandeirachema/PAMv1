...
runs 0–227 and 229–233, and **every phase has shipped**, and the current
tagged, cosign-signed release is
**[v0.63.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.63.0)** (2026-08-31;
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.63.0**. Releases
...
**[v0.63.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.63.0)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.63.0`, is published and public.)
...
```bash
TAG=v0.63.0                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.63.0 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.63.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.63.0)
was released on 2026-08-31** and is what every manifest here pins — image digest
`sha256:5ecdd79921ae4fc577d3b8924d0201113f28d0f18c91174cec28fdff395287a6`, public
