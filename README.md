...
runs 0–197 and **every phase has shipped**, and the current
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.53.0**. Releases
...
**[v0.53.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.53.0)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.53.0`, is published and public.)
...
```bash
TAG=v0.53.0                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.53.0 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.53.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.53.0)
was released on 2026-08-25** and is what every manifest here pins — image digest
`sha256:d1e6c4f4f2bd4335e154653adbbecb2073f34ce9ad5f7bccb2e652aedeb75262`, public
