...
runs 0–212 and **every phase has shipped**, and the current
tagged, cosign-signed release is
**[v0.57.1](https://github.com/morandeirachema/pamv1/releases/tag/v0.57.1)** (2026-08-26;
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.57.1**. Releases
...
**[v0.57.1](https://github.com/morandeirachema/pamv1/releases/tag/v0.57.1)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.57.1`, is published and public.)
...
```bash
TAG=v0.57.1                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.57.1 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.57.1](https://github.com/morandeirachema/pamv1/releases/tag/v0.57.1)
was released on 2026-08-26** and is what every manifest here pins — image digest
`sha256:279a5d8b82d698a4215d7076bc548a93f1cddd954e709c17af9c8c433a51b875`, public
