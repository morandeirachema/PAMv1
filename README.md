...
**[v0.58.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.58.0)** (2026-08-26;
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.58.0**. Releases
...
**[v0.58.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.58.0)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.58.0`, is published and public.)
...
```bash
TAG=v0.58.0                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.58.0 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.58.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.58.0)
