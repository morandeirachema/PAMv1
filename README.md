...
runs 0–68 and **every phase has shipped**, and the current
tagged, cosign-signed release is
**[v0.13.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.13.0)** (2026-08-08;
...
**[v0.13.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.13.0)** keep it there, each cut the same day its phases merged
...
> `ghcr.io/morandeirachema/pamv1:0.13.0`, is published and public.)
...
```bash
TAG=v0.13.0                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.13.0 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.13.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.13.0)
was released on 2026-08-08** and is what every manifest here pins; its predecessor
v0.12.0 carried digest
`sha256:f324e2b14ba9ce49706cd14c51f7ecfb1326d1a874f2fcced7f76eee88a61f8e`, and each
