...
runs 0–223 and **every phase has shipped**, and the current
tagged, cosign-signed release is
**[v0.60.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.60.0)** (2026-08-27;
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.60.0**. Releases
...
**[v0.60.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.60.0)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.60.0`, is published and public.)
...
```bash
TAG=v0.60.0                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.60.0 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.60.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.60.0)
was released on 2026-08-27** and is what every manifest here pins — image digest
`sha256:55f70935cc5395b3f20a61cf7ab23a2e7f69237b07c1254f4191f93eca1b69f7`, public
