...
runs 0–161 and **every phase has shipped**, and the current
tagged, cosign-signed release is
**[v0.43.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.43.0)** (2026-08-17;
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.43.0**. Releases
...
**[v0.43.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.43.0)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.43.0`, is published and public.)
...
```bash
TAG=v0.43.0                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.43.0 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.43.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.43.0)
was released on 2026-08-17** and is what every manifest here pins — image digest
`sha256:0562b828f585840047cb6d19c9a336a166e000cf537af3f8065afe543f785cd0`, public
