...
runs 0–225 and **every phase has shipped**, and the current
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.61.0**. Releases
...
**[v0.61.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.61.0)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.61.0`, is published and public.)
...
```bash
TAG=v0.61.0                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.61.0 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.61.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.61.0)
was released on 2026-08-27** and is what every manifest here pins — image digest
`sha256:50be5f7cc29258ce9a8faa1e1c90d6d8b0a088ded9929a1d97b531a9dc4112a2`, public
