...
runs 0–227 and 229–243, and **every phase has shipped**, and the current
tagged, cosign-signed release is
**[v0.67.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.67.0)** (2026-09-03;
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.67.0**. Releases
...
**[v0.67.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.67.0)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.67.0`, is published and public.)
...
```bash
TAG=v0.67.0                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.67.0 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.67.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.67.0)
was released on 2026-09-03** and is what every manifest here pins — image digest
`sha256:e7f1a5ffd28e5a4c8b0f9e2fb296b8e0b3356210a3f61fc49b15ca572e0a81bb`, public
