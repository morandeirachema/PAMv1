...
runs 0–148 and **every phase has shipped**, and the current
tagged, cosign-signed release is
**[v0.37.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.37.0)** (2026-08-16;
...
Phases 0–147, grouped by area. Every capability is exercised by tests and deploys as code.
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.37.0**. Releases
...
**[v0.37.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.37.0)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.37.0`, is published and public.)
...
```bash
TAG=v0.37.0                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.37.0 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.37.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.37.0)
was released on 2026-08-16** and is what every manifest here pins — image digest
`sha256:cc31cf8726ffd1fb7338f7ca7cd554de30be267e07b0e23b70c468ceb7449af3`, public
