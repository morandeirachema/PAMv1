...
runs 0–70 and **every phase has shipped**, and the current
tagged, cosign-signed release is
**[v0.14.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.14.0)** (2026-08-08;
...
**[v0.12.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.12.0)** and
**[v0.13.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.13.0)** and
**[v0.14.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.14.0)** keep it there, each cut the same day its phases merged
rather than letting them bank.
...
> `ghcr.io/morandeirachema/pamv1:0.14.0`, is published and public.)
...
```bash
TAG=v0.14.0                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.14.0 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.14.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.14.0)
was released on 2026-08-08** and is what every manifest here pins; its predecessor
v0.13.0 carried digest
`sha256:b239f0a4c4bd0aaa3aec0088c78a0eabcbe9ee1549e725ff7e556acbf4eb5131`, and each
tag's own digest is on its release page. (`v0.11.1` is a source tag only: its pipeline failed
