...
broker four-eyes sound — released steadily as **v0.10.0 → v0.29.0**. Releases
...
**[v0.29.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.29.0)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.29.0`, is published and public.)
...
```bash
TAG=v0.29.0                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.29.0 (<full commit sha>)
