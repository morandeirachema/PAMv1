...
**[v0.35.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.35.0)** (2026-08-15;
...
Phases 0–143, grouped by area. Every capability is exercised by tests and deploys as code.
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.35.0**. Releases
...
**[v0.35.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.35.0)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.35.0`, is published and public.)
...
```bash
TAG=v0.35.0                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.35.0 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.35.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.35.0)
