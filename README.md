...
runs 0–210 and **every phase has shipped**, and the current
tagged, cosign-signed release is
**[v0.57.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.57.0)** (2026-08-26;
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.57.0**. Releases
...
**[v0.57.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.57.0)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.57.0`, is published and public.)
...
```bash
TAG=v0.57.0                       # the released version
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.57.0 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.57.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.57.0)
was released on 2026-08-26** and is what every manifest here pins — image digest
`sha256:75a2a43d58dc01247d4af1a56ac56ae3bd2fe535bcec0aedc93791375f995ad0`, public
