...
runs 0–214 and **every phase has shipped**, and the current
tagged, cosign-signed release is
**[v0.58.1](https://github.com/morandeirachema/pamv1/releases/tag/v0.58.1)** (2026-08-26;
...
broker four-eyes sound — released steadily as **v0.10.0 → v0.58.1**. Releases
...
**[v0.58.1](https://github.com/morandeirachema/pamv1/releases/tag/v0.58.1)**. The full list is in
...
> `ghcr.io/morandeirachema/pamv1:0.58.1`, is published and public.)
...
```bash
kubectl -n pamv1 exec deploy/pamv1 -- /pam-server -version   # → pam-server 0.58.1 (<full commit sha>)
curl -s http://pamv1:8080/metrics | grep pam_build_info      # same, for monitoring
```

**Status:** **[v0.58.1](https://github.com/morandeirachema/pamv1/releases/tag/v0.58.1)
was released on 2026-08-26** and is what every manifest here pins — image digest
`sha256:67e9ee722b35904e55f96828bc5338f09a66e7f3c1b2cf25bd1568232818bb7b`, public
