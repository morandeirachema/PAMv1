...
**todas las releases posteriores** la han mantenido ahí, cada una cortada el mismo
día en que se fusionaron sus fases en lugar de dejarlas acumularse — la última,
la **[v0.15.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.15.0)**. La lista completa está en
