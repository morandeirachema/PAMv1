...
abarca de la 0 a la 227 y de la 229 a la 269, **se han entregado todas las fases**, y la release etiquetada y
...
v0.0.77** (la numeración pasó a 0.0.x en la v0.0.77). Las releases quedan registradas en **[CHANGELOG.md](CHANGELOG.md)**;
...
**[v0.0.77](https://github.com/morandeirachema/pamv1/releases/tag/v0.0.77)**. La lista completa está en
