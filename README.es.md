...
abarca de la 0 a la 70, **se han entregado todas las fases**, y la release etiquetada y
...
**[v0.11.2](https://github.com/morandeirachema/pamv1/releases/tag/v0.11.2)** y la
**[v0.12.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.12.0)** y la
**[v0.13.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.13.0)** y la
**[v0.14.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.14.0)** la mantienen ahí, cada una cortada el mismo día en que se
fusionaron sus fases en lugar de dejarlas acumularse.
