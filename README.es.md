...
abarca de la 0 a la 152, **se han entregado todas las fases**, y la release etiquetada y
...
v0.39.0**. Las releases quedan registradas en **[CHANGELOG.md](CHANGELOG.md)**;
...
**[v0.39.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.39.0)**. La lista completa está en
