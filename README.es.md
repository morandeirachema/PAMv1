...
abarca de la 0 a la 218, **se han entregado todas las fases**, y la release etiquetada y
...
v0.58.3**. Las releases quedan registradas en **[CHANGELOG.md](CHANGELOG.md)**;
...
**[v0.58.3](https://github.com/morandeirachema/pamv1/releases/tag/v0.58.3)**. La lista completa está en
