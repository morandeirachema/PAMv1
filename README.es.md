...
abarca de la 0 a la 121, **se han entregado todas las fases**, y la release etiquetada y
...
Fases 0–122, agrupadas por área. Cada capacidad está cubierta por tests y se despliega como código.
...
Se han entregado todas las fases (0–121) — detalle por fase en **[ROADMAP.md](ROADMAP.md)**:
...
v0.24.0**. Las releases quedan registradas en **[CHANGELOG.md](CHANGELOG.md)**;
...
**[v0.24.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.24.0)**. La lista completa está en
