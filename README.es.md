...
abarca de la 0 a la 214, **se han entregado todas las fases**, y la release etiquetada y
...
v0.58.1**. Las releases quedan registradas en **[CHANGELOG.md](CHANGELOG.md)**;
...
**[v0.58.1](https://github.com/morandeirachema/pamv1/releases/tag/v0.58.1)**. La lista completa está en
