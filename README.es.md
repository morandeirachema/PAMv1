...
abarca de la 0 a la 227 y de la 229 a la 230, **se han entregado todas las fases**, y la release etiquetada y
...
v0.62.1**. Las releases quedan registradas en **[CHANGELOG.md](CHANGELOG.md)**;
...
**[v0.62.1](https://github.com/morandeirachema/pamv1/releases/tag/v0.62.1)**. La lista completa está en
