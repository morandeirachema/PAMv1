...
abarca de la 0 a la 227 y de la 229 a la 259, **se han entregado todas las fases**, y la release etiquetada y
...
Fases 0–227 y 229–259, agrupadas por área. Cada capacidad está cubierta por tests y se despliega como código.
...
v0.74.0**. Las releases quedan registradas en **[CHANGELOG.md](CHANGELOG.md)**;
...
**[v0.74.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.74.0)**. La lista completa está en
