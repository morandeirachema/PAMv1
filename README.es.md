...
Fases 0–145, agrupadas por área. Cada capacidad está cubierta por tests y se despliega como código.
...
v0.35.0**. Las releases quedan registradas en **[CHANGELOG.md](CHANGELOG.md)**;
...
**[v0.35.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.35.0)**. La lista completa está en
