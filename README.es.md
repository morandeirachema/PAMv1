...
abarca de la 0 a la 190, **se han entregado todas las fases**, y la release etiquetada y
...
v0.52.0**. Las releases quedan registradas en **[CHANGELOG.md](CHANGELOG.md)**;
...
**[v0.52.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.52.0)**. La lista completa está en
