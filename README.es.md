...
abarca de la 0 a la 148, **se han entregado todas las fases**, y la release etiquetada y
...
Fases 0–147, agrupadas por área. Cada capacidad está cubierta por tests y se despliega como código.
...
v0.37.0**. Las releases quedan registradas en **[CHANGELOG.md](CHANGELOG.md)**;
...
**[v0.37.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.37.0)**. La lista completa está en
