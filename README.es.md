...
Fases 0–143, agrupadas por área. Cada capacidad está cubierta por tests y se despliega como código.
...
v0.34.0**. Las releases quedan registradas en **[CHANGELOG.md](CHANGELOG.md)**;
...
**[v0.34.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.34.0)**. La lista completa está en
