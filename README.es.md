...
abarca de la 0 a la 227 y de la 229 a la 233, **se han entregado todas las fases**, y la release etiquetada y
...
v0.63.0**. Las releases quedan registradas en **[CHANGELOG.md](CHANGELOG.md)**;
...
**[v0.63.0](https://github.com/morandeirachema/pamv1/releases/tag/v0.63.0)**. La lista completa está en
