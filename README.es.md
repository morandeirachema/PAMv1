...
abarca de la 0 a la 204, **se han entregado todas las fases**, y la release etiquetada y
...
v0.54.1**. Las releases quedan registradas en **[CHANGELOG.md](CHANGELOG.md)**;
...
**[v0.54.1](https://github.com/morandeirachema/pamv1/releases/tag/v0.54.1)**. La lista completa está en
