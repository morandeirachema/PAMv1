...
abarca de la 0 a la 108, **se han entregado todas las fases**, y la release etiquetada y
...
v0.18.2**. Las releases quedan registradas en **[CHANGELOG.md](CHANGELOG.md)**;
...
**[v0.18.2](https://github.com/morandeirachema/pamv1/releases/tag/v0.18.2)**. La lista completa está en
