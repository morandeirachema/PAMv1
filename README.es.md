...
abarca de la 0 a la 216, **se han entregado todas las fases**, y la release etiquetada y
...
v0.58.2**. Las releases quedan registradas en **[CHANGELOG.md](CHANGELOG.md)**;
...
**[v0.58.2](https://github.com/morandeirachema/pamv1/releases/tag/v0.58.2)**. La lista completa está en
