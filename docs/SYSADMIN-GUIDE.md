...
>
> Last updated: 2026-08-08 · Reflects: Phases 0–70. Phases 53–70 add one background worker (the hourly, leader-locked certification scheduler — always on, nothing to configure beyond `PAM_CERT_REMIND_DAYS`) and migrations `0025`–`0031`, all additive and applied at startup; nothing else in this runbook changes..
