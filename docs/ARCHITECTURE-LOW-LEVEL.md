...
| `PAM_AUDIT_FORWARD_ADDR` | — (off) | host:port of a SIEM collector; streams every audit event to it (Phase 35). `PAM_AUDIT_FORWARD_PROTO` (udp/tcp), `PAM_AUDIT_FORWARD_FORMAT` (rfc5424/cef), `PAM_AUDIT_FORWARD_INTERVAL_SEC` (10) tune it |
