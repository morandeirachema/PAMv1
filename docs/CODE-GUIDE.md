...
>
> Last updated: 2026-09-02 · Reflects: Phases 0–227 and 229–249 + the 2026-07 hardening passes.
>
...
- **`pgstore`** (`store/pgstore`) — PostgreSQL via [pgx](https://github.com/jackc/pgx).
  ...
  every later change is a new numbered file (through `0057_target_labels.sql` at time of writing).
