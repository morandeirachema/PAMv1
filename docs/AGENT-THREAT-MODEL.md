...
fields, which is why the two sections below are new.
>
> Scope: the **AI-agent access broker** (Phases 13, 27, 30, 38, 39, 40, 43, 52c, 52d, 159, 161) — `internal/broker`,
