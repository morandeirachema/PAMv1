...
>
> Last updated: 2026-08-18 · Reflects: Phases 0–174. Phases 161–173 add no requirement: two additive migrations applied at startup (`0044`, `0045`) on the PostgreSQL instance already required, three optional knobs (`PAM_BROKER_MAX_RESULT_BYTES` from 165, `PAM_BROKER_BUDGET_PER_DAY` from 167, `PAM_BROKER_REQUIRE_ENROLLED_SVID` from 174), and no new dependency, listener or external system. Phases 66–70 add one more
