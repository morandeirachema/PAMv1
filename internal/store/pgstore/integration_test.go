...
func TestPGStoreContract(t *testing.T) {
	...
	if _, err := pool.Exec(ctx,
		`TRUNCATE targets, credentials, target_grants, access_requests, checkouts,
		 ...
		 credential_dependencies, campaigns, campaign_items, app_keys, app_secret_grants, agent_call_reservations,
		 ssh_certificates, vendors, vendor_grants, key_material, live_sessions, stepups
